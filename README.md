...
部署于 **https://bot.cstar.com** 的进出口供应链工具与平台源代码。
...
| 发票·装箱单生成器 | v1.0.0 | 老瑞 | 外贸单证一键生成：一次录入抬头与货物明细，同时生成商业发票 CI、形式发票 PI、装箱单 PL（中英双语）。自动汇总数量/金额/件数/净重毛重/CBM、金额英文大写，支持唛头/贸易术语/付款/银行信息；历史台账、示例数据、本地暂存，打印/PDF/Word + 货物明细 Excel 导出。 | `/trade-docs-app.html` | `aeo/portal/trade-docs-app.html` |
