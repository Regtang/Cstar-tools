...
| HS编码·申报要素速查 | v1.0.0 | 老瑞 | 报关前速查：按 HS 编码/商品名检索归类、规范申报要素、监管条件、检验检疫类别，及最惠国/普通关税、进口增值税、出口退税、消费税率；附监管证件代码对照，打印/PDF/Word 申报参考单 + 速查库导出。示例数据。 | `/hs-lookup-app.html` | `aeo/portal/hs-lookup-app.html` |
